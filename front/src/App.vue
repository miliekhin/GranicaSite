...
import KpButton from "./components/KpButton.vue"
...
import BlockFeedback from "./components/PageIndex/BlockFeedback.vue"
import BlockFooter from "./components/PageIndex/BlockFooter.vue"
import PopTip from "./components/PopTip.vue"
import BlockAdvertising from "./components/PageIndex/BlockAdvertising.vue";
export default {
  components:{
    BlockAdvertising,
    PopTip,
