    ...
    return{
      ...
      inputsData: [
        ...
        },
        {
          ...
          bottomText: "Введите наименование документа, страна выдачи, " +
              "серия номер, дата выдачи.Пример: Паспорт гражданина ДНР 4258 234567 01.02.2020г.",
          localStorageKey: "identityDocument"
        },
        {
          topText: "Адрес постоянного места жительства (регистрации)",
          bottomText: "Пример: ДНР, Донецкая область, г. Донецк, ул. Артёма, д.12 кв.11",
          localStorageKey: "homeAddress"
        },
        {
          topText: "Адрес временного проживания (пребывания) в государстве – члене ЕАЭС",
          bottomText: "Пример: Россия, Ростовская область, г. Таганрог, ул. Ленина д.22",
          localStorageKey: "tempAddress"
        },
        {
          topText: "Страна отправления",
          bottomText: "Введите ДНР или Украина в зависимости от того, по какому документу будете выезжать",
        ...
        },
        {
          ...
          bottomText: "Пример: В012АЕDPR, ДНР",
